...
MVP funcionalmente completo, construído em 21 iterações disciplinadas ("um prompt = um PR"). HEAD atual é pós-Prompt 21 (tick de score ao vivo migrado para Redis).
