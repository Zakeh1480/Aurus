...
- Prompt 17 — Redis adapter para Socket.IO em `apps/api` (`@socket.io/redis-adapter`), entrega de eventos WS cross-instance-safe via rooms por usuário ← estado atual
