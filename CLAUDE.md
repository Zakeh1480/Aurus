...
MVP funcionalmente completo, construído em 22 iterações disciplinadas ("um prompt = um PR"). HEAD atual é pós-Prompt 22 (desafios de anti-cheat migrados para Redis) — os três schedulers em memória documentados como lacuna nos Prompts 17-19 (`MatchDurationSchedulerService`, `ScoreTickSchedulerService`, `ChallengeSchedulerService`) estão todos cross-instance-safe agora.
