...
export function LoginForm() {
  ...
  // Mesma flag de RegisterForm: evita que este efeito dispare um redirect
  // concorrente com o do próprio submit (ambos vão para `next ?? "/"` aqui,
  // mas a corrida ainda pode causar uma navegação duplicada/piscada).
