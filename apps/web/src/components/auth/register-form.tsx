...
export function RegisterForm() {
  ...
  // flag, o login() feito no submit já deixa `status` authenticated, e este
  // efeito mandaria para "/" por cima do router.push("/consentimento").
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-4" noValidate>
      ...
      <FormField label="Confirmar senha" htmlFor="passwordConfirmation" error={errors.passwordConfirmation?.message}>
        <Input
