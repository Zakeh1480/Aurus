...
/**
 * Mantém o keyframe bem abaixo de ANTI_CHEAT_MAX_KEYFRAME_BASE64_LENGTH
 * (~300KB decodificados) com boa folga — 320px de largura em JPEG qualidade
 * 0.6 fica na casa de dezenas de KB, não centenas.
 */
...
/** Captura um snapshot JPEG reduzido do frame atual do vídeo, em base64 (sem prefixo data:). */
